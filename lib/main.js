...
function commandRun(path, args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const toolRunner = new toolrunner_1.ToolRunner(path, args, { cwd: '/home/runner/work/install-kubeflow/install-kubeflow' });
        core.debug(msg);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        args = ['-lsa'];
        yield commandRun('ls', args);
        args = ['.'];
        yield commandRun('pwd', args);
        args = ['kubeflow'];
        yield commandRun('cd', args);
        // args = ['generate', 'all', '-V'];
